...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meter.bill_data_import'
        db.add_column('BuildingSpeakApp_meter', 'bill_data_import',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meter.bill_data_import'
        db.delete_column('BuildingSpeakApp_meter', 'bill_data_import')
