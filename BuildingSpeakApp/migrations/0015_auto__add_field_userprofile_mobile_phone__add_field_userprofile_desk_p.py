...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.mobile_phone'
        db.add_column(u'BuildingSpeakApp_userprofile', 'mobile_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.desk_phone'
        db.add_column(u'BuildingSpeakApp_userprofile', 'desk_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.mobile_phone'
        db.delete_column(u'BuildingSpeakApp_userprofile', 'mobile_phone')

        # Deleting field 'UserProfile.desk_phone'
        db.delete_column(u'BuildingSpeakApp_userprofile', 'desk_phone')
