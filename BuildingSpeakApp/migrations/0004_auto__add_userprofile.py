...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BuildingSpeakApp_userprofile', (
        ...
        m2m_table_name = db.shorten_name(u'BuildingSpeakApp_userprofile_messages')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'BuildingSpeakApp_userprofile')

        # Removing M2M table for field messages on 'UserProfile'
        db.delete_table(db.shorten_name(u'BuildingSpeakApp_userprofile_messages'))
