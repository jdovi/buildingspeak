...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monthling.base_billing_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_billing_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.base_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.base_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.base_kBtuh_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_kBtuh_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.base_kBtu_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_kBtu_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.base_cost_delta'
        db.add_column('BuildingSpeakApp_monthling', 'base_cost_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_billing_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_billing_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_kBtuh_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_kBtuh_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_kBtu_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_kBtu_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.exp_cost_delta'
        db.add_column('BuildingSpeakApp_monthling', 'exp_cost_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_billing_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_billing_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_kBtuh_peak_demand_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_kBtuh_peak_demand_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_kBtu_consumption_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_kBtu_consumption_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.esave_cost_delta'
        db.add_column('BuildingSpeakApp_monthling', 'esave_cost_delta',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monthling.base_billing_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_billing_demand_delta')

        # Deleting field 'Monthling.base_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_peak_demand_delta')

        # Deleting field 'Monthling.base_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_consumption_delta')

        # Deleting field 'Monthling.base_kBtuh_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_kBtuh_peak_demand_delta')

        # Deleting field 'Monthling.base_kBtu_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_kBtu_consumption_delta')

        # Deleting field 'Monthling.base_cost_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'base_cost_delta')

        # Deleting field 'Monthling.exp_billing_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_billing_demand_delta')

        # Deleting field 'Monthling.exp_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_peak_demand_delta')

        # Deleting field 'Monthling.exp_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_consumption_delta')

        # Deleting field 'Monthling.exp_kBtuh_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_kBtuh_peak_demand_delta')

        # Deleting field 'Monthling.exp_kBtu_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_kBtu_consumption_delta')

        # Deleting field 'Monthling.exp_cost_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'exp_cost_delta')

        # Deleting field 'Monthling.esave_billing_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_billing_demand_delta')

        # Deleting field 'Monthling.esave_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_peak_demand_delta')

        # Deleting field 'Monthling.esave_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_consumption_delta')

        # Deleting field 'Monthling.esave_kBtuh_peak_demand_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_kBtuh_peak_demand_delta')

        # Deleting field 'Monthling.esave_kBtu_consumption_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_kBtu_consumption_delta')

        # Deleting field 'Monthling.esave_cost_delta'
        db.delete_column('BuildingSpeakApp_monthling', 'esave_cost_delta')
    ...
    models = {
        ...
        'BuildingSpeakApp.baselinemodel': {
            ...
            'SEE': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'SSQreg': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'SSQres': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'SSQtotal': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta00': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta01': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta02': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta03': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta04': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta05': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'beta06': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
