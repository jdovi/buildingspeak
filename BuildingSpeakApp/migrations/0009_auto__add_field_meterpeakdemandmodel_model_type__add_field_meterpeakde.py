...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'model_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.first_month'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'first_month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.last_month'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'last_month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.Tccp'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Tccp',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.Thcp'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Thcp',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.prediction_alpha'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'prediction_alpha',
                      self.gf('django.db.models.fields.FloatField')(default=0.1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.meter'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'meter',
        ...
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta00v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10v'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10v',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.r_squared'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'r_squared',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.adj_r_squared'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'adj_r_squared',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.p'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'p',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.df'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'df',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.Yavg'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Yavg',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.SSQres'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'SSQres',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.rmse'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'rmse',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.cvrmse'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'cvrmse',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.nbe'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'nbe',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.F_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'F_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.F_stat_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'F_stat_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.autocorr_coeff'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'autocorr_coeff',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.acceptance_score'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'acceptance_score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta00_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta00_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta00_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta00_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta01_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta02_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta03_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta04_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta05_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta06_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta07_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta08_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta09_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10_se'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_se',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10_t_stat'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_t_stat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10_p_value'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_p_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeterPeakDemandModel.beta10_95_conf_int'
        db.add_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_95_conf_int',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field messages on 'MeterPeakDemandModel'
        m2m_table_name = db.shorten_name(u'BuildingSpeakApp_meterpeakdemandmodel_messages')
        ...
        db.create_unique(m2m_table_name, ['meterpeakdemandmodel_id', 'message_id'])


    def backwards(self, orm):
        # Deleting field 'MeterPeakDemandModel.model_type'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'model_type')

        # Deleting field 'MeterPeakDemandModel.first_month'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'first_month')

        # Deleting field 'MeterPeakDemandModel.last_month'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'last_month')

        # Deleting field 'MeterPeakDemandModel.Tccp'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Tccp')

        # Deleting field 'MeterPeakDemandModel.Thcp'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Thcp')

        # Deleting field 'MeterPeakDemandModel.prediction_alpha'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'prediction_alpha')

        # Deleting field 'MeterPeakDemandModel.meter'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'meter_id')

        # Deleting field 'MeterPeakDemandModel.beta00p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00p')

        # Deleting field 'MeterPeakDemandModel.beta01p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01p')

        # Deleting field 'MeterPeakDemandModel.beta02p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02p')

        # Deleting field 'MeterPeakDemandModel.beta03p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03p')

        # Deleting field 'MeterPeakDemandModel.beta04p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04p')

        # Deleting field 'MeterPeakDemandModel.beta05p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05p')

        # Deleting field 'MeterPeakDemandModel.beta06p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06p')

        # Deleting field 'MeterPeakDemandModel.beta07p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07p')

        # Deleting field 'MeterPeakDemandModel.beta08p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08p')

        # Deleting field 'MeterPeakDemandModel.beta09p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09p')

        # Deleting field 'MeterPeakDemandModel.beta10p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10p')

        # Deleting field 'MeterPeakDemandModel.beta00v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00v')

        # Deleting field 'MeterPeakDemandModel.beta01v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01v')

        # Deleting field 'MeterPeakDemandModel.beta02v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02v')

        # Deleting field 'MeterPeakDemandModel.beta03v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03v')

        # Deleting field 'MeterPeakDemandModel.beta04v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04v')

        # Deleting field 'MeterPeakDemandModel.beta05v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05v')

        # Deleting field 'MeterPeakDemandModel.beta06v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06v')

        # Deleting field 'MeterPeakDemandModel.beta07v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07v')

        # Deleting field 'MeterPeakDemandModel.beta08v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08v')

        # Deleting field 'MeterPeakDemandModel.beta09v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09v')

        # Deleting field 'MeterPeakDemandModel.beta10v'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10v')

        # Deleting field 'MeterPeakDemandModel.r_squared'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'r_squared')

        # Deleting field 'MeterPeakDemandModel.adj_r_squared'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'adj_r_squared')

        # Deleting field 'MeterPeakDemandModel.p'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'p')

        # Deleting field 'MeterPeakDemandModel.df'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'df')

        # Deleting field 'MeterPeakDemandModel.Yavg'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'Yavg')

        # Deleting field 'MeterPeakDemandModel.SSQres'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'SSQres')

        # Deleting field 'MeterPeakDemandModel.rmse'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'rmse')

        # Deleting field 'MeterPeakDemandModel.cvrmse'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'cvrmse')

        # Deleting field 'MeterPeakDemandModel.nbe'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'nbe')

        # Deleting field 'MeterPeakDemandModel.F_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'F_stat')

        # Deleting field 'MeterPeakDemandModel.F_stat_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'F_stat_p_value')

        # Deleting field 'MeterPeakDemandModel.autocorr_coeff'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'autocorr_coeff')

        # Deleting field 'MeterPeakDemandModel.acceptance_score'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'acceptance_score')

        # Deleting field 'MeterPeakDemandModel.beta00_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_se')

        # Deleting field 'MeterPeakDemandModel.beta00_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta00_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_p_value')

        # Deleting field 'MeterPeakDemandModel.beta00_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta00_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta01_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_se')

        # Deleting field 'MeterPeakDemandModel.beta01_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta01_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_p_value')

        # Deleting field 'MeterPeakDemandModel.beta01_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta01_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta02_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_se')

        # Deleting field 'MeterPeakDemandModel.beta02_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta02_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_p_value')

        # Deleting field 'MeterPeakDemandModel.beta02_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta02_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta03_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_se')

        # Deleting field 'MeterPeakDemandModel.beta03_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta03_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_p_value')

        # Deleting field 'MeterPeakDemandModel.beta03_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta03_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta04_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_se')

        # Deleting field 'MeterPeakDemandModel.beta04_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta04_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_p_value')

        # Deleting field 'MeterPeakDemandModel.beta04_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta04_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta05_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_se')

        # Deleting field 'MeterPeakDemandModel.beta05_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta05_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_p_value')

        # Deleting field 'MeterPeakDemandModel.beta05_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta05_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta06_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_se')

        # Deleting field 'MeterPeakDemandModel.beta06_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta06_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_p_value')

        # Deleting field 'MeterPeakDemandModel.beta06_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta06_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta07_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_se')

        # Deleting field 'MeterPeakDemandModel.beta07_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta07_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_p_value')

        # Deleting field 'MeterPeakDemandModel.beta07_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta07_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta08_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_se')

        # Deleting field 'MeterPeakDemandModel.beta08_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta08_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_p_value')

        # Deleting field 'MeterPeakDemandModel.beta08_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta08_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta09_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_se')

        # Deleting field 'MeterPeakDemandModel.beta09_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta09_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_p_value')

        # Deleting field 'MeterPeakDemandModel.beta09_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta09_95_conf_int')

        # Deleting field 'MeterPeakDemandModel.beta10_se'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_se')

        # Deleting field 'MeterPeakDemandModel.beta10_t_stat'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_t_stat')

        # Deleting field 'MeterPeakDemandModel.beta10_p_value'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_p_value')

        # Deleting field 'MeterPeakDemandModel.beta10_95_conf_int'
        db.delete_column(u'BuildingSpeakApp_meterpeakdemandmodel', 'beta10_95_conf_int')

        # Removing M2M table for field messages on 'MeterPeakDemandModel'
        db.delete_table(db.shorten_name(u'BuildingSpeakApp_meterpeakdemandmodel_messages'))
