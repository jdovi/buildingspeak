...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'EnergyMeasure'
        db.delete_table('BuildingSpeakApp_energymeasure')

        # Removing M2M table for field messages on 'EnergyMeasure'
        db.delete_table('BuildingSpeakApp_energymeasure_messages')

        # Deleting model 'ECMEquipmentApportionment'
        db.delete_table('BuildingSpeakApp_ecmequipmentapportionment')

        # Deleting model 'ECMMeterApportionment'
        db.delete_table('BuildingSpeakApp_ecmmeterapportionment')
        ...
        db.create_table('BuildingSpeakApp_efficiencymeasure', (
            ...
            ('annual_consumption_savings', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('peak_demand_savings', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('annual_cost_savings', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_cool', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_heat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_flat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_fixed', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
        ...
        # Adding model 'EfficiencyMeasureMeterApportionment'
        db.create_table('BuildingSpeakApp_efficiencymeasuremeterapportionment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('BuildingSpeakApp', ['EfficiencyMeasureMeterApportionment'])

        # Adding model 'EfficiencyMeasureEquipmentApportionment'
        db.create_table('BuildingSpeakApp_efficiencymeasureequipmentapportionment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.Equipment'])),
            ('efficiency_measure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.EfficiencyMeasure'])),
            ('assigned_fraction', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3, blank=True)),
        ))
        db.send_create_signal('BuildingSpeakApp', ['EfficiencyMeasureEquipmentApportionment'])


    def backwards(self, orm):
        # Adding model 'EnergyMeasure'
        db.create_table('BuildingSpeakApp_energymeasure', (
            ('utility_type', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('nov_peak', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_cool', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
            ('percent_heat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True)),
        ...
        db.send_create_signal('BuildingSpeakApp', ['EnergyMeasure'])

        # Adding M2M table for field messages on 'EnergyMeasure'
        db.create_table('BuildingSpeakApp_energymeasure_messages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('energymeasure', models.ForeignKey(orm['BuildingSpeakApp.energymeasure'], null=False)),
            ('message', models.ForeignKey(orm['BuildingSpeakApp.message'], null=False))
        ))
        db.create_unique('BuildingSpeakApp_energymeasure_messages', ['energymeasure_id', 'message_id'])

        # Adding model 'ECMEquipmentApportionment'
        db.create_table('BuildingSpeakApp_ecmequipmentapportionment', (
            ('assigned_fraction', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3, blank=True)),
            ('energymeasure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.EnergyMeasure'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.Equipment'])),
        ))
        db.send_create_signal('BuildingSpeakApp', ['ECMEquipmentApportionment'])

        # Adding model 'ECMMeterApportionment'
        db.create_table('BuildingSpeakApp_ecmmeterapportionment', (
            ('assigned_fraction', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3, blank=True)),
            ('energymeasure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.EnergyMeasure'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.Meter'])),
        ))
        db.send_create_signal('BuildingSpeakApp', ['ECMMeterApportionment'])
        ...
        # Deleting model 'EfficiencyMeasureMeterApportionment'
        db.delete_table('BuildingSpeakApp_efficiencymeasuremeterapportionment')

        # Deleting model 'EfficiencyMeasureEquipmentApportionment'
        db.delete_table('BuildingSpeakApp_efficiencymeasureequipmentapportionment')
    ...
    models = {
        ...
        'BuildingSpeakApp.efficiencymeasure': {
            ...
            'equipments': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Equipment']", 'through': "orm['BuildingSpeakApp.EfficiencyMeasureEquipmentApportionment']", 'symmetrical': 'False'}),
            ...
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Message']", 'symmetrical': 'False'}),
            'meters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Meter']", 'through': "orm['BuildingSpeakApp.EfficiencyMeasureMeterApportionment']", 'symmetrical': 'False'}),
        ...
        'BuildingSpeakApp.efficiencymeasureequipmentapportionment': {
            'Meta': {'object_name': 'EfficiencyMeasureEquipmentApportionment'},
            'assigned_fraction': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '3', 'blank': 'True'}),
        ...
        'BuildingSpeakApp.efficiencymeasuremeterapportionment': {
            'Meta': {'object_name': 'EfficiencyMeasureMeterApportionment'},
            'assigned_fraction': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '3', 'blank': 'True'}),
            'efficiency_measure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.EfficiencyMeasure']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.Meter']"})
