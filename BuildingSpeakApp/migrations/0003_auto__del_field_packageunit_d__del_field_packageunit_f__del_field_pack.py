...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackageUnit.d'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'd')

        # Deleting field 'PackageUnit.f'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'f')

        # Deleting field 'PackageUnit.e'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'e')

        # Deleting field 'PackageUnit.m'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'm')

        # Adding field 'PackageUnit.d0'
        db.add_column(u'BuildingSpeakApp_packageunit', 'd0',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.d1'
        db.add_column(u'BuildingSpeakApp_packageunit', 'd1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.d2'
        db.add_column(u'BuildingSpeakApp_packageunit', 'd2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.m0'
        db.add_column(u'BuildingSpeakApp_packageunit', 'm0',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.m1'
        db.add_column(u'BuildingSpeakApp_packageunit', 'm1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.m2'
        db.add_column(u'BuildingSpeakApp_packageunit', 'm2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.m3'
        db.add_column(u'BuildingSpeakApp_packageunit', 'm3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.f0'
        db.add_column(u'BuildingSpeakApp_packageunit', 'f0',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.f1'
        db.add_column(u'BuildingSpeakApp_packageunit', 'f1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.f2'
        db.add_column(u'BuildingSpeakApp_packageunit', 'f2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.e0'
        db.add_column(u'BuildingSpeakApp_packageunit', 'e0',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.e1'
        db.add_column(u'BuildingSpeakApp_packageunit', 'e1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.e2'
        db.add_column(u'BuildingSpeakApp_packageunit', 'e2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PackageUnit.d'
        db.add_column(u'BuildingSpeakApp_packageunit', 'd',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='decimal', null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.f'
        db.add_column(u'BuildingSpeakApp_packageunit', 'f',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='decimal', null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.e'
        db.add_column(u'BuildingSpeakApp_packageunit', 'e',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='decimal', null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageUnit.m'
        db.add_column(u'BuildingSpeakApp_packageunit', 'm',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='decimal', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PackageUnit.d0'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'd0')

        # Deleting field 'PackageUnit.d1'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'd1')

        # Deleting field 'PackageUnit.d2'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'd2')

        # Deleting field 'PackageUnit.m0'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'm0')

        # Deleting field 'PackageUnit.m1'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'm1')

        # Deleting field 'PackageUnit.m2'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'm2')

        # Deleting field 'PackageUnit.m3'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'm3')

        # Deleting field 'PackageUnit.f0'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'f0')

        # Deleting field 'PackageUnit.f1'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'f1')

        # Deleting field 'PackageUnit.f2'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'f2')

        # Deleting field 'PackageUnit.e0'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'e0')

        # Deleting field 'PackageUnit.e1'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'e1')

        # Deleting field 'PackageUnit.e2'
        db.delete_column(u'BuildingSpeakApp_packageunit', 'e2')
    ...
    models = {
        'BuildingSpeakApp.account': {
            ...
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Message']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'readers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Reader']", 'symmetrical': 'False', 'blank': 'True'}),
            'schedules': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.OperatingSchedule']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'BuildingSpeakApp.equipment': {
            ...
            'buildings': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['BuildingSpeakApp.Building']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'equipment_type': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['BuildingSpeakApp.Message']", 'null': 'True', 'blank': 'True'}),
            'meters': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['BuildingSpeakApp.Meter']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'provided_file_time_zone': ('django.db.models.fields.CharField', [], {'default': "'US/Eastern'", 'max_length': '200', 'blank': 'True'}),
            'provided_file_track': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'readers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['BuildingSpeakApp.Reader']", 'null': 'True', 'blank': 'True'}),
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.OperatingSchedule']", 'null': 'True', 'blank': 'True'}),
            'spaces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['BuildingSpeakApp.Space']", 'null': 'True', 'blank': 'True'})
        },
        'BuildingSpeakApp.gapowerpandl': {
            ...
            'use_input_billing_demand': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'BuildingSpeakApp.monther': {
            ...
            'consumption_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.MeterConsumptionModel']", 'null': 'True', 'blank': 'True'}),
            'help_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Message']", 'symmetrical': 'False', 'blank': 'True'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.Meter']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'peak_demand_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.MeterPeakDemandModel']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'BuildingSpeakApp.operatingschedule': {
            ...
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.Message']", 'symmetrical': 'False', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'units': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.UnitSchedule']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'BuildingSpeakApp.packageunit': {
            'Meta': {'object_name': 'PackageUnit', '_ormbases': ['BuildingSpeakApp.Equipment']},
            ...
            'age': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'd0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'd1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'd2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            ...
            'e0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'e1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'e2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            ...
            'f0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'f1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'f2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'm0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'm1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'm2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'm3': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '3', 'blank': 'True'}),
            'make': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'model': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'BuildingSpeakApp.rateschedule': {
            ...
            'riders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BuildingSpeakApp.RateScheduleRider']", 'symmetrical': 'False', 'blank': 'True'}),
            'utility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BuildingSpeakApp.Utility']"})
        },
