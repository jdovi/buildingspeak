...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.stripe_token'
        db.delete_column(u'BuildingSpeakApp_account', 'stripe_token')

        # Adding field 'Account.stripe_customer_id'
        db.add_column(u'BuildingSpeakApp_account', 'stripe_customer_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Account.stripe_token'
        db.add_column(u'BuildingSpeakApp_account', 'stripe_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Account.stripe_customer_id'
        db.delete_column(u'BuildingSpeakApp_account', 'stripe_customer_id')
