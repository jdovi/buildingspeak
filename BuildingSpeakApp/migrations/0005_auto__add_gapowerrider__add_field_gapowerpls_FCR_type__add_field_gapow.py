...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BuildingSpeakApp_gapowerrider', (
            (u'rateschedulerider_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['BuildingSpeakApp.RateScheduleRider'], unique=True, primary_key=True)),
        ...
        # Adding field 'GAPowerPLS.FCR_type'
        db.add_column(u'BuildingSpeakApp_gapowerpls', 'FCR_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'GAPowerPLS.MFF_type'
        db.add_column(u'BuildingSpeakApp_gapowerpls', 'MFF_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding M2M table for field riders on 'RateSchedule'
        m2m_table_name = db.shorten_name(u'BuildingSpeakApp_rateschedule_riders')
        ...
        db.create_unique(m2m_table_name, ['rateschedule_id', 'rateschedulerider_id'])

        # Deleting field 'RateScheduleRider.rate_schedule'
        db.delete_column(u'BuildingSpeakApp_rateschedulerider', 'rate_schedule_id')

        # Adding field 'RateScheduleRider.utility'
        db.add_column(u'BuildingSpeakApp_rateschedulerider', 'utility',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['BuildingSpeakApp.Utility']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GAPowerRider'
        db.delete_table(u'BuildingSpeakApp_gapowerrider')

        # Deleting field 'GAPowerPLS.FCR_type'
        db.delete_column(u'BuildingSpeakApp_gapowerpls', 'FCR_type')

        # Deleting field 'GAPowerPLS.MFF_type'
        db.delete_column(u'BuildingSpeakApp_gapowerpls', 'MFF_type')

        # Removing M2M table for field riders on 'RateSchedule'
        db.delete_table(db.shorten_name(u'BuildingSpeakApp_rateschedule_riders'))

        # Adding field 'RateScheduleRider.rate_schedule'
        db.add_column(u'BuildingSpeakApp_rateschedulerider', 'rate_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['BuildingSpeakApp.RateSchedule']),
                      keep_default=False)

        # Deleting field 'RateScheduleRider.utility'
        db.delete_column(u'BuildingSpeakApp_rateschedulerider', 'utility_id')
    ...
    models = {
        ...
        'BuildingSpeakApp.gapowerpls': {
            'FCR_type': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'MFF_type': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
