...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeatherDataPoint.cloudCover'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'cloudCover', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipIntensityMaxTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensityMaxTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.temperatureMin'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMin', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperature'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperature', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.dewPoint'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'dewPoint', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMax'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMaxTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMaxTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.windBearing'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'windBearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipAccumulation'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipAccumulation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMinTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMinTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.visibility'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'visibility', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.sunsetTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'sunsetTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.pressure'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'pressure', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipIntensityMax'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensityMax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.humidity'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'humidity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.ozone'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'ozone', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.windSpeed'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'windSpeed', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.time'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.precipIntensity'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.sunriseTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'sunriseTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WeatherDataPoint.precipProbability'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipProbability', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'WeatherDataPoint.cloudCover'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'cloudCover', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipIntensityMaxTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensityMaxTime', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.temperatureMin'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMin', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperature'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperature', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.dewPoint'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'dewPoint', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMax'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMax', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMaxTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMaxTime', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.windBearing'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'windBearing', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipAccumulation'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipAccumulation', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.temperatureMinTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'temperatureMinTime', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.visibility'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'visibility', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.sunsetTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'sunsetTime', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.pressure'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'pressure', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.precipIntensityMax'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensityMax', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.humidity'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'humidity', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.ozone'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'ozone', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.windSpeed'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'windSpeed', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.time'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'time', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.precipIntensity'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipIntensity', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))

        # Changing field 'WeatherDataPoint.sunriseTime'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'sunriseTime', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'WeatherDataPoint.precipProbability'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipProbability', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=3))
