...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipment.schedule'
        db.alter_column(u'BuildingSpeakApp_equipment', 'schedule_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.OperatingSchedule'], null=True))

    def backwards(self, orm):

        # Changing field 'Equipment.schedule'
        db.alter_column(u'BuildingSpeakApp_equipment', 'schedule_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['BuildingSpeakApp.OperatingSchedule']))
