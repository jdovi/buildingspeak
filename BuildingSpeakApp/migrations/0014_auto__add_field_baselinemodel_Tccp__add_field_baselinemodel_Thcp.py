...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaselineModel.Tccp'
        db.add_column('BuildingSpeakApp_baselinemodel', 'Tccp',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaselineModel.Thcp'
        db.add_column('BuildingSpeakApp_baselinemodel', 'Thcp',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaselineModel.Tccp'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'Tccp')

        # Deleting field 'BaselineModel.Thcp'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'Thcp')
