...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monther.consumption_model'
        db.add_column('BuildingSpeakApp_monther', 'consumption_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.MeterConsumptionModel'], null=True),
                      keep_default=False)

        # Adding field 'Monther.peak_demand_model'
        db.add_column('BuildingSpeakApp_monther', 'peak_demand_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.MeterPeakDemandModel'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monther.consumption_model'
        db.delete_column('BuildingSpeakApp_monther', 'consumption_model_id')

        # Deleting field 'Monther.peak_demand_model'
        db.delete_column('BuildingSpeakApp_monther', 'peak_demand_model_id')
