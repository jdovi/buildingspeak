...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaselineModel.model_variable'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'model_variable')

        # Adding field 'BaselineModel.modeled_variable'
        db.add_column('BuildingSpeakApp_baselinemodel', 'modeled_variable',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BaselineModel.model_variable'
        db.add_column('BuildingSpeakApp_baselinemodel', 'model_variable',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'BaselineModel.modeled_variable'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'modeled_variable')
    ...
    models = {
        ...
        'BuildingSpeakApp.baselinemodel': {
            ...
            'modeled_variable': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
