...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GeneralConsumption'
        db.create_table('BuildingSpeakApp_generalconsumption', (
            ...
            ('rate_type', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('rate_per_unit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=7, blank=True)),
            ('moving_average_window_length', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('max_number_same_months', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('BuildingSpeakApp', ['GeneralConsumption'])


    def backwards(self, orm):
        # Deleting model 'GeneralConsumption'
        db.delete_table('BuildingSpeakApp_generalconsumption')
    ...
    models = {
        ...
        'BuildingSpeakApp.generalconsumption': {
            'Meta': {'object_name': 'GeneralConsumption', '_ormbases': ['BuildingSpeakApp.RateSchedule']},
            'max_number_same_months': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'moving_average_window_length': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rate_per_unit': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '7', 'blank': 'True'}),
            'rate_type': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'rateschedule_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['BuildingSpeakApp.RateSchedule']", 'unique': 'True', 'primary_key': 'True'}),
            'units': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
