...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field messages on 'BaselineModel'
        db.delete_table('BuildingSpeakApp_baselinemodel_messages')
    ...
    def backwards(self, orm):
        ...
        db.create_table('BuildingSpeakApp_baselinemodel', (
            ...
            ('beta04p', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('beta02_se', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('modeled_variable', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('beta04v', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('nbe', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('beta05_se', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('p', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        # Adding M2M table for field messages on 'BaselineModel'
        db.create_table('BuildingSpeakApp_baselinemodel_messages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baselinemodel', models.ForeignKey(orm['BuildingSpeakApp.baselinemodel'], null=False)),
            ('message', models.ForeignKey(orm['BuildingSpeakApp.message'], null=False))
        ))
        db.create_unique('BuildingSpeakApp_baselinemodel_messages', ['baselinemodel_id', 'message_id'])
