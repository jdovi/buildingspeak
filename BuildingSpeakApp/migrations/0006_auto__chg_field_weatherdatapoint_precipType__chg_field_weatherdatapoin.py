...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeatherDataPoint.precipType'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipType', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'WeatherDataPoint.summary'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'summary', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'WeatherDataPoint.icon'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'icon', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'WeatherDataPoint.precipType'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'precipType', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'WeatherDataPoint.summary'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'summary', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'WeatherDataPoint.icon'
        db.alter_column('BuildingSpeakApp_weatherdatapoint', 'icon', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
