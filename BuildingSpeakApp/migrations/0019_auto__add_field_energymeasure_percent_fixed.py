...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnergyMeasure.percent_fixed'
        db.add_column('BuildingSpeakApp_energymeasure', 'percent_fixed',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnergyMeasure.percent_fixed'
        db.delete_column('BuildingSpeakApp_energymeasure', 'percent_fixed')
