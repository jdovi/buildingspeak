...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monther.current_baseline_model'
        db.add_column('BuildingSpeakApp_monther', 'current_baseline_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.BaselineModel'], null=True),
                      keep_default=False)

        # Adding field 'BaselineModel.meter'
        db.add_column('BuildingSpeakApp_baselinemodel', 'meter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BuildingSpeakApp.Meter'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monther.current_baseline_model'
        db.delete_column('BuildingSpeakApp_monther', 'current_baseline_model_id')

        # Deleting field 'BaselineModel.meter'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'meter_id')
