...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'KnowsChild'
        db.delete_table('BuildingSpeakApp_knowschild')

        # Adding field 'RateSchedule._my_subclass'
        db.add_column('BuildingSpeakApp_rateschedule', '_my_subclass',
                      self.gf('django.db.models.fields.CharField')(default='rateschedule', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'KnowsChild'
        db.create_table('BuildingSpeakApp_knowschild', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_my_subclass', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('BuildingSpeakApp', ['KnowsChild'])

        # Deleting field 'RateSchedule._my_subclass'
        db.delete_column('BuildingSpeakApp_rateschedule', '_my_subclass')
    ...
    models = {
        ...
        'BuildingSpeakApp.rateschedulesubclass': {
            'Meta': {'object_name': 'RateScheduleSubclass', '_ormbases': ['BuildingSpeakApp.RateSchedule']},
