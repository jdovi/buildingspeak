...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Monthling.hdd_peak_demand'
        db.add_column('BuildingSpeakApp_monthling', 'hdd_peak_demand',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Monthling.cdd_peak_demand'
        db.add_column('BuildingSpeakApp_monthling', 'cdd_peak_demand',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=3, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Monthling.hdd_peak_demand'
        db.delete_column('BuildingSpeakApp_monthling', 'hdd_peak_demand')

        # Deleting field 'Monthling.cdd_peak_demand'
        db.delete_column('BuildingSpeakApp_monthling', 'cdd_peak_demand')
