...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PackageUnit'
        db.create_table('BuildingSpeakApp_packageunit', (
        ...
        db.send_create_signal('BuildingSpeakApp', ['PackageUnit'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PackageUnit'
        db.delete_table('BuildingSpeakApp_packageunit')
