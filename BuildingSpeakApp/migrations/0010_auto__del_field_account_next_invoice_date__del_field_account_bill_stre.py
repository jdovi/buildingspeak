...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.next_invoice_date'
        db.delete_column(u'BuildingSpeakApp_account', 'next_invoice_date')

        # Deleting field 'Account.bill_street_address'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_street_address')

        # Deleting field 'Account.bill_addressee'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_addressee')

        # Deleting field 'Account.last_paid_date'
        db.delete_column(u'BuildingSpeakApp_account', 'last_paid_date')

        # Deleting field 'Account.bill_to_email'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_to_email')

        # Deleting field 'Account.last_invoice_date'
        db.delete_column(u'BuildingSpeakApp_account', 'last_invoice_date')

        # Deleting field 'Account.bill_state'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_state')

        # Deleting field 'Account.bill_zip_code'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_zip_code')

        # Deleting field 'Account.bill_email_address'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_email_address')

        # Deleting field 'Account.bill_city'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_city')

        # Deleting field 'Account.bill_to_location'
        db.delete_column(u'BuildingSpeakApp_account', 'bill_to_location')


    def backwards(self, orm):
        # Adding field 'Account.next_invoice_date'
        db.add_column(u'BuildingSpeakApp_account', 'next_invoice_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_street_address'
        db.add_column(u'BuildingSpeakApp_account', 'bill_street_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_addressee'
        db.add_column(u'BuildingSpeakApp_account', 'bill_addressee',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Account.last_paid_date'
        db.add_column(u'BuildingSpeakApp_account', 'last_paid_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_to_email'
        db.add_column(u'BuildingSpeakApp_account', 'bill_to_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Account.last_invoice_date'
        db.add_column(u'BuildingSpeakApp_account', 'last_invoice_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_state'
        db.add_column(u'BuildingSpeakApp_account', 'bill_state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_zip_code'
        db.add_column(u'BuildingSpeakApp_account', 'bill_zip_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_email_address'
        db.add_column(u'BuildingSpeakApp_account', 'bill_email_address',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_city'
        db.add_column(u'BuildingSpeakApp_account', 'bill_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Account.bill_to_location'
        db.add_column(u'BuildingSpeakApp_account', 'bill_to_location',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
