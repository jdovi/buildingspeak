...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeatherStation.tz_name'
        db.add_column('BuildingSpeakApp_weatherstation', 'tz_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeatherStation.tz_name'
        db.delete_column('BuildingSpeakApp_weatherstation', 'tz_name')
