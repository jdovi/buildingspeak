...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GAPowerPandL.use_input_billing_demand'
        db.add_column(u'BuildingSpeakApp_gapowerpandl', 'use_input_billing_demand',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GAPowerPandL.use_input_billing_demand'
        db.delete_column(u'BuildingSpeakApp_gapowerpandl', 'use_input_billing_demand')
