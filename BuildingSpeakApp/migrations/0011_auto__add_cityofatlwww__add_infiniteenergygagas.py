...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BuildingSpeakApp_cityofatlwww', (
        ...
        db.create_table(u'BuildingSpeakApp_infiniteenergygagas', (
            (u'rateschedule_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['BuildingSpeakApp.RateSchedule'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'BuildingSpeakApp_cityofatlwww')

        # Deleting model 'InfiniteEnergyGAGas'
        db.delete_table(u'BuildingSpeakApp_infiniteenergygagas')
