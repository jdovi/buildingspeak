...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaselineModel.acceptance_score'
        db.add_column('BuildingSpeakApp_baselinemodel', 'acceptance_score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaselineModel.acceptance_score'
        db.delete_column('BuildingSpeakApp_baselinemodel', 'acceptance_score')
